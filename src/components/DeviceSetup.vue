<template>
  <div>
    <form class="form" v-on:submit="sendPost">
      ...
      <table>
        <tr> <td> f_A0 = <input class="border rounded" type="number" step="0.0001" style="text-align: right;" v-model="device.f_Aa"> &times; <input class="border rounded" type="number" steps="0.0001" v-model="device.V_A0"> &#43; <input class="border rounded" type="number" step="0.0001" v-model="device.f_Ab"> = {{f_A0.toFixed(4)}} </td> </tr>
        <tr> <td> f_B0 = <input class="border rounded" type="number" step="0.0001" style="text-align: right;" v-model="device.f_Ba"> &times; <input class="border rounded" type="number" steps="0.0001" v-model="device.V_B0"> &#43; <input class="border rounded" type="number" step="0.0001" v-model="device.f_Bb"> = {{f_B0.toFixed(4)}} </td> </tr>
        <tr> <td> f_C0 = <input class="border rounded" type="number" step="0.0001" style="text-align: right;" v-model="device.f_Ca"> &times; <input class="border rounded" type="number" steps="0.0001" v-model="device.V_C0"> &#43; <input class="border rounded" type="number" step="0.0001" v-model="device.f_Cb"> = {{f_C0.toFixed(4)}} </td> </tr>
        <tr> <td> f_D0 = <input class="border rounded" type="number" step="0.0001" style="text-align: right;" v-model="device.f_Da"> &times; <input class="border rounded" type="number" steps="0.0001" v-model="device.V_D0"> &#43; <input class="border rounded" type="number" step="0.0001" v-model="device.f_Db"> = {{f_D0.toFixed(4)}} </td> </tr>
        <tr>&nbsp;</tr>
